...
<body class="bg-gray-50 text-gray-800 font-sans antialiased">
    ...
    <div class="max-w-6xl mx-auto px-4 py-16" x-data="{ tab: 'ruang-lingkup' }">
        <div class="text-center mb-12">
            <span class="px-4 py-1.5 bg-blue-100 text-blue-700 text-xs font-bold rounded-full uppercase tracking-widest mb-4 inline-block">Layanan Unggulan</span>
            <h1 class="text-5xl font-extrabold text-blue-950 mb-4 tracking-tight">Laboratorium Sentral Ilmu Hayati (LSIH)</h1>
            <p class="text-xl text-gray-500 max-w-2xl mx-auto leading-relaxed">Penyediaan jasa pengujian Laboratorium Sentral Ilmu Hayati untuk mendukung riset dan industri Hayati di Indonesia.</p>
        </div>
        ...
        <div class="flex justify-center mb-12">
            <nav class="inline-flex p-1.5 bg-gray-200/80 backdrop-blur-sm rounded-2xl border border-gray-300/50">
                ...
                <button 
                    @click="tab = 'tarif'" 
                    :class="tab === 'tarif' ? 'bg-white text-blue-900 shadow-md ring-1 ring-black/5' : 'text-gray-500 hover:text-gray-800 hover:bg-gray-300/50'"
                    class="px-5 py-2.5 rounded-xl text-sm font-bold transition-all duration-300 focus:outline-none flex items-center"
                >
