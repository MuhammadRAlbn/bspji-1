                ...
                <div class="grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-4 md:gap-12">
                    ...
                    <div>
                        ...
                        <ul class="space-y-2 text-sm text-slate-400">
                            ...
                            <li><a href="#layanan" class="transition-colors hover:text-white">Layanan Kami</a></li>
                            <li><a href="#sertifikat" class="transition-colors hover:text-white">Sertifikat</a></li>
                            <li><a href="#peta-pelanggan" class="transition-colors hover:text-white">Peta Pelanggan</a></li>
                        </ul>
                    </div>
                    <div>
