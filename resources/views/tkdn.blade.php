...
<head>
    ...
    <title>Verifikasi TKDN - BSPJI Pekanbaru</title>
...
<body class="bg-gray-50 text-gray-800 font-sans antialiased">
    ...
    <div class="max-w-6xl mx-auto px-4 py-16" x-data="{ tab: 'ruang-lingkup' }">
        <div class="text-center mb-12">
            <span class="px-4 py-1.5 bg-green-100 text-green-700 text-xs font-bold rounded-full uppercase tracking-widest mb-4 inline-block">Layanan Sertifikasi</span>
            <h1 class="text-5xl font-extrabold text-green-950 mb-4 tracking-tight">Verifikasi TKDN</h1>
            <p class="text-xl text-gray-500 max-w-2xl mx-auto leading-relaxed">Verifikasi Tingkat Komponen Dalam Negeri (TKDN) untuk mendukung penggunaan produk dalam negeri.</p>
        </div>
