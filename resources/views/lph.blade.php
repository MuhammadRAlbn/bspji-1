                    ...
                    @forelse($ruangLingkup as $item)
                        @if($item->gambar)
                            <button
                                ...
                                class="group relative block w-full cursor-pointer overflow-hidden rounded-[24px] text-left border border-black/10 shadow-sm transition-all hover:shadow-md"
                            >
                                <img
