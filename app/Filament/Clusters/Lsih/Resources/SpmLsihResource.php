...
use App\Filament\Clusters\Lsih\Resources\SpmLsihResource\Pages;
...
class SpmLsihResource extends Resource
{
    protected static ?string $model = SpmLsih::class;
    ...
    public static function form(Schema $schema): Schema
    {
        return $schema->schema([
            FileUpload::make('image_path')
                ...
                ->nestedRecursiveRule(
                    fn (?SpmLsih $record): AuthorizedSpmImageUpload => new AuthorizedSpmImageUpload(
                ...
                ->disk('public')
                ->directory(ConvertUploadedImageToWebp::DIRECTORY_LSIH)
                ->visibility('public')
                ->saveUploadedFileUsing(
                    function (
                        ...
                        try {
                            return $converter->execute($file, ConvertUploadedImageToWebp::DIRECTORY_LSIH);
    ...
    {
        return [
            'index' => Pages\ListSpmLsihs::route('/'),
            'create' => Pages\CreateSpmLsih::route('/create'),
            'edit' => Pages\EditSpmLsih::route('/{record}/edit'),
        ];
    }

    public static function canCreate(): bool
    {
        return parent::canCreate() && ! SpmLsih::query()->exists();
    }
}
