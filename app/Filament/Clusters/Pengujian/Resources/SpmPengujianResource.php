...
use App\Filament\Clusters\Pengujian\Resources\SpmPengujianResource\Pages;
...
class SpmPengujianResource extends Resource
{
    protected static ?string $model = SpmPengujian::class;
    ...
    public static function form(Schema $schema): Schema
    {
        return $schema->schema([
            FileUpload::make('image_path')
                ...
                ->nestedRecursiveRule(
                    fn (?SpmPengujian $record): AuthorizedSpmImageUpload => new AuthorizedSpmImageUpload(
                ...
                ->disk('public')
                ->directory(ConvertUploadedImageToWebp::DIRECTORY)
                ->visibility('public')
    ...
    {
        return [
            'index' => Pages\ListSpmPengujians::route('/'),
            'create' => Pages\CreateSpmPengujian::route('/create'),
            'edit' => Pages\EditSpmPengujian::route('/{record}/edit'),
        ];
    }

    public static function canCreate(): bool
    {
        return parent::canCreate() && ! SpmPengujian::query()->exists();
    }
}
